...
function AddThoughtForm(props) {
  var addThought = props.addThought;
...
function App() {
  ...
  var addThought = function addThought(newThought) {
    setThoughts(function (prev) {
      return [newThought].concat(_toConsumableArray(prev));
    });
  };

  var deleteThought = function deleteThought(thoughtIdToRemove) {
    setThoughts(thoughts.filter(function (thought) {
