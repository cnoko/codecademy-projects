...
if (showBackground) content.push(background);
...
function displayFact(e) {
  ...
  var selectedAnimal = _animals.animals[key];
  var optionIndex = Math.floor(Math.random() * selectedAnimal.facts.length);
  var fact = _animals.animals[key].facts[optionIndex];
...
},{"./animals":168,"react":167,"react-dom":29}]},{},[169]);
